  ...
  useEffect(() => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        const resp = await fetch(`${API_URL}send-telegram`, {
          method: "POST",
      ...
      <div className="max-w-5xl mx-auto bg-white shadow-lg rounded-lg p-4 md:p-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between border-b pb-4 mb-6 gap-4">
          ...
          <div className="text-xs md:text-sm text-gray-600 space-y-1">
            <p>
              <strong>Today’s Date:</strong> ________
            </p>
            <p>
              <strong>Address Applied For:</strong> __________________
            </p>
          </div>
        </div>
        ...
        <form id="rentalForm" className="space-y-8">
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-4 mt-4">
              <input
                name="Landlord/Mortgage"
                type="text"
                placeholder="Landlord or Mortgage Company"
                className="border p-2 rounded w-full"
              />
              <input
                name="Landlord Phone"
                type="tel"
                placeholder="Landlord Phone (Required if available)"
                className="border p-2 rounded w-full"
              />
            </div>
          ...
          <section>
            ...
            <label className="font-medium block mb-2">
              Proposed Occupants / Ages
            </label>
            <div className="grid md:grid-cols-3 gap-4">
              <input
                name="Occupant 1"
                type="text"
                placeholder="Occupant / Age"
                className="border p-2 rounded w-full"
              />
              <input
                name="Occupant 2"
          ...
          <section>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <input
                ...
                type="text"
                placeholder="Funds Available Now (USD)"
                className="border p-2 rounded w-full"
              />
              <input
                name="Proposed Move-in Date"
                type="date"
                className="border p-2 rounded w-full"
              />
            </div>
          ...
          <section>
            ...
            <div className="text-sm text-gray-700 bg-gray-50 p-4 rounded leading-relaxed">
              The Applicant consents to the collection, use, and disclosure of
              personal information by the Landlord and/or agent of the Landlord
              for the purpose of determining creditworthiness for leasing,
              selling, or financing of the premises or the real property. By
              submitting this form, the Applicant represents that all statements
              made are true and correct. The Applicant is hereby notified that a
              consumer report containing credit and/or personal information may
              be referred to in connection with this rental. The Applicant
              authorizes the verification of the information contained in this
              application and information obtained from personal references.
            </div>
          </section>
          ...
          <section>
            ...
            <div className="bg-yellow-100 p-4 rounded mb-3">
              <p className="font-semibold text-yellow-800 mb-2">
                APPLICATION FEE IS $60 — IT’S REFUNDABLE *
              </p>
